...
FILES:${PN} += "/usr/lib/os-release /usr/lib/rpm/macros.d/macros.dist"
...
do_install() {
    ...
    install -d ${D}/usr/lib
    install -d ${D}/usr/lib/rpm/macros.d
    install -d ${D}/etc
    ...
    install -m 0755 ${WORKDIR}/sources/macros.dist ${D}/usr/lib/rpm/macros.d/macros.dist
}
